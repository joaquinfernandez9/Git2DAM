...
@Provider
public class ErrorDatabaseExceptionMapper implements ExceptionMapper<ErrorDatabaseException> {

    public Response toResponse(ErrorDatabaseException exception) {
